...
class SenateCommitteeAppropriations extends EventScraper_Abstract 
{
    
    protected $url = 'http://www3.capwiz.com/c-span/dbq/officials/schedule.dbq?committee=sappr&command=committee_schedules&chambername=Senate&chamber=S&period=';
    public $parser_name = 'C-SPAN Senate Appropriations Schedule Scraper';
    ...
    protected function scrape()
    {
        ...
        foreach($li[1] as $li_str) {
            if(!preg_match('/<a href=/is',$li_str)) {
                ...
                $events[$i]['title'] = (string) 'Senate Appropriations Schedule';
...
$parser = new SenateCommitteeAppropriations;
$parser->run();
