...
class SenateCommitteeRules extends EventScraper_Abstract 
{
    
    protected $url = 'http://www3.capwiz.com/c-span/dbq/officials/schedule.dbq?committee=hrule&command=committee_schedules&chambername=Senate&chamber=S&period=';
    public $parser_name = 'C-SPAN Senate Rules Committee Schedule';
...
$parser = new SenateCommitteeRules;
$parser->run();
