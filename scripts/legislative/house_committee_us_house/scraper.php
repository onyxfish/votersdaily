...
class HouseCommitteeUSHouseofRepresentatives extends EventScraper_Abstract 
{
    ...
    protected function scrape()
    {
        ...
        foreach($li[1] as $li_str) {
            if(!preg_match('/<a href=/is',$li_str)) {
                ...
                $events[$i]['title'] = (string) 'House US House of Representatives  Schedule';
...
$parser = new HouseCommitteeUSHouseofRepresentatives;
$parser->run();
