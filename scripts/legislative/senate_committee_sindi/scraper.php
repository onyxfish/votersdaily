...
class SenateCommitteeIndianAffairs extends EventScraper_Abstract 
{
    ...
    protected function scrape()
    {
        ...
        foreach($li[1] as $li_str) {
            if(!preg_match('/<a href=/is',$li_str)) {
                ...
                $events[$i]['title'] = (string) 'Senate Indian Affairs Schedule';
...
$parser = new SenateCommitteeIndianAffairs;
$parser->run();
