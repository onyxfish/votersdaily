...
class SenateCommitteeTransportationInfrastructure extends EventScraper_Abstract 
{
    
    protected $url = 'http://www3.capwiz.com/c-span/dbq/officials/schedule.dbq?committee=htran&command=committee_schedules&chambername=Senate&chamber=S&period=';
    public $parser_name = 'C-SPAN Senate Transportation and Infrastructure Committee Schedule';
...
$parser = new SenateCommitteeTransportationInfrastructure;
$parser->run();
