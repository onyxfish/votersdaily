...
class SenateCommitteeFinancialServices extends EventScraper_Abstract 
{
    
    protected $url = 'http://www3.capwiz.com/c-span/dbq/officials/schedule.dbq?committee=hbank&command=committee_schedules&chambername=Senate&chamber=S&period=';
    public $parser_name = 'C-SPAN Senate Committee Financial Services Schedule';
...
$parser = new SenateCommitteeFinancialServices;
$parser->run();
