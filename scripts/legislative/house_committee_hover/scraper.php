...
class HouseCommitteeHouseAdministration extends EventScraper_Abstract 
{
    ...
    public $parser_name = 'C-SPAN House Administration Committee Schedule Scraper';
...
$parser = new HouseCommitteeHouseAdministration;
$parser->run();
