...
class SenateCommitteeSmallBusinessEntrepreneurship extends EventScraper_Abstract 
{
    
    protected $url = 'http://www3.capwiz.com/c-span/dbq/officials/schedule.dbq?committee=ssbus&command=committee_schedules&chambername=Senate&chamber=S&period=';
    public $parser_name = 'C-SPAN Senate Small Business and Entrepreneurship Committee Schedule Scraper';
    ...
    protected function scrape()
    {
        ...
        foreach($li[1] as $li_str) {
            if(!preg_match('/<a href=/is',$li_str)) {
                ...
                $events[$i]['title'] = (string) 'Senate Small Business and Entrepreneurship Committee  Schedule';
...
$parser = new SenateCommitteeSmallBusinessEntrepreneurship;
$parser->run();
