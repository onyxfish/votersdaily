...
class SenateCommitteeHomelandSecurity extends EventScraper_Abstract 
{
    
    protected $url = 'http://www3.capwiz.com/c-span/dbq/officials/schedule.dbq?committee=hhome&command=committee_schedules&chambername=Senate&chamber=S&period=';
    public $parser_name = 'C-SPAN Senate Homeland Security Committee Schedule';
...
$parser = new SenateCommitteeHomelandSecurity;
$parser->run();
