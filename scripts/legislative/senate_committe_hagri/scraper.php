...
class SenateCommitteeAgriculture extends EventScraper_Abstract 
{
    
    protected $url = 'http://www3.capwiz.com/c-span/dbq/officials/schedule.dbq?committee=hagri&command=committee_schedules&chambername=Senate&chamber=S&period=';
...
$parser = new SenateCommitteeAgriculture;
$parser->run();
