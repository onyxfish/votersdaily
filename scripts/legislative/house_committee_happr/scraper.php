...
class HouseCommitteeAppropriations extends EventScraper_Abstract 
{
    
    protected $url = 'http://www3.capwiz.com/c-span/dbq/officials/schedule.dbq?committee=sappr&command=committee_schedules&chambername=House&chamber=H&period=';
    public $parser_name = 'C-SPAN House Appropriations Schedule Scraper';
    ...
    protected function scrape()
    {
        ...
        foreach($li[1] as $li_str) {
            if(!preg_match('/<a href=/is',$li_str)) {
                ...
                $events[$i]['title'] = (string) 'House Appropriations Schedule';
...
$parser = new HouseCommitteeAppropriations;
$parser->run();
