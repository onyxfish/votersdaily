...
class SenateCommitteeUSHouseofRepresentatives extends EventScraper_Abstract 
{
    
    protected $url = 'http://www3.capwiz.com/c-span/dbq/officials/schedule.dbq?committee=us_house&command=committee_schedules&chambername=Senate&chamber=S&period=';
    public $parser_name = 'C-SPAN Senate US House of Representatives  Schedule';
...
$parser = new SenateCommitteeUSHouseofRepresentatives;
$parser->run();
