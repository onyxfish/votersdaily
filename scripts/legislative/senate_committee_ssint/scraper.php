...
class SenateCommitteePermanentSelectCommitteeIntelligence extends EventScraper_Abstract 
{
    
    protected $url = 'http://www3.capwiz.com/c-span/dbq/officials/schedule.dbq?committee=ssint&command=committee_schedules&chambername=Senate&chamber=S&period=';
    public $parser_name = 'C-SPAN Senate Permanent Select Committee on Intelligence Schedule Scraper';
    ...
    protected function scrape()
    {
        ...
        foreach($li[1] as $li_str) {
            if(!preg_match('/<a href=/is',$li_str)) {
                ...
                $events[$i]['title'] = (string) 'Senate Permanent Select Committee on Intelligence Schedule';
...
$parser = new SenateCommitteePermanentSelectCommitteeIntelligence;
$parser->run();
