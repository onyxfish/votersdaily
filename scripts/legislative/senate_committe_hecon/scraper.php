...
class SenateCommitteeEducationLabor extends EventScraper_Abstract 
{
    
    protected $url = 'http://www3.capwiz.com/c-span/dbq/officials/schedule.dbq?committee=hecon&command=committee_schedules&chambername=Senate&chamber=S&period=';
    public $parser_name = 'C-SPAN Senate Education and Labor Schedule';
...
$parser = new SenateCommitteeEducationLabor;
$parser->run();
