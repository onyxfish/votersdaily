...
class SenateCommitteeWaysMeans extends EventScraper_Abstract 
{
    
    protected $url = 'http://www3.capwiz.com/c-span/dbq/officials/schedule.dbq?committee=hways&command=committee_schedules&chambername=Senate&chamber=S&period=';
    public $parser_name = 'C-SPAN Senate Ways and Means Committee Schedule';
...
$parser = new SenateCommitteeWaysMeans;
$parser->run();
