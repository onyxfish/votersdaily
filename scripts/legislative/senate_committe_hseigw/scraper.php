...
class SenateCommitteeSelectCommitteeEnergyIndependenceGlobalWarming extends EventScraper_Abstract 
{
    
    protected $url = 'http://www3.capwiz.com/c-span/dbq/officials/schedule.dbq?committee=hseigw&command=committee_schedules&chambername=Senate&chamber=S&period=';
    public $parser_name = 'C-SPAN Senate Select Committee on Energy Independence and Global Warming Schedule';
...
$parser = new SenateCommitteeSelectCommitteeEnergyIndependenceGlobalWarming;
$parser->run();
