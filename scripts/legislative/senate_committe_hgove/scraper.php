...
class SenateCommitteeOversightGovernmentReform extends EventScraper_Abstract 
{
    
    protected $url = 'http://www3.capwiz.com/c-span/dbq/officials/schedule.dbq?committee=hgove&command=committee_schedules&chambername=Senate&chamber=S&period=';
    public $parser_name = 'C-SPAN Senate Oversight and Government Reform Committee Schedule';
...
$parser = new SenateCommitteeOversightGovernmentReform;
$parser->run();
