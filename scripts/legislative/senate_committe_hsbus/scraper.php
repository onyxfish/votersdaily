...
class SenateCommitteeSmallBusiness extends EventScraper_Abstract 
{
    
    protected $url = 'http://www3.capwiz.com/c-span/dbq/officials/schedule.dbq?committee=hsbus&command=committee_schedules&chambername=Senate&chamber=S&period=';
    public $parser_name = 'C-SPAN Senate Small Business Committee  Schedule';
...
$parser = new SenateCommitteeSmallBusiness;
$parser->run();
