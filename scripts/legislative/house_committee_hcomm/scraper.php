...
class HouseCommitteeEnergyCommerce extends EventScraper_Abstract 
{
    ...
    protected function scrape()
    {
        ...
        foreach($li[1] as $li_str) {
            if(!preg_match('/<a href=/is',$li_str)) {
                ...
                $events[$i]['title'] = (string) 'House Energy and Commerce Committee Schedule';
...
$parser = new HouseCommitteeEnergyCommerce;
$parser->run();
