...
class SenateCommitteeUsSenate extends EventScraper_Abstract 
{
    ...
    public $parser_name = 'C-SPAN US Senate Schedule Scraper';
    ...
    protected function scrape()
    {
        ...
        foreach($li[1] as $li_str) {
            if(!preg_match('/<a href=/is',$li_str)) {
                ...
                $events[$i]['title'] = (string) 'US Senate Schedule';
...
$parser = new SenateCommitteeUsSenate;
$parser->run();
