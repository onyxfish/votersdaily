...
class SenateCommitteeSelectCommitteeEthics extends EventScraper_Abstract 
{
    
    protected $url = 'http://www3.capwiz.com/c-span/dbq/officials/schedule.dbq?committee=sethi&command=committee_schedules&chambername=Senate&chamber=S&period=';
    public $parser_name = 'C-SPAN Senate Select Committee on Ethics Schedule Scraper';
    ...
    protected function scrape()
    {
        ...
        foreach($li[1] as $li_str) {
            if(!preg_match('/<a href=/is',$li_str)) {
                ...
                $events[$i]['title'] = (string) 'Senate Select Committee on Ethics Schedule';
...
$parser = new SenateCommitteeSelectCommitteeEthics;
$parser->run();
