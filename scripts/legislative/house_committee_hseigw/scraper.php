...
class HouseCommitteeSelectCommitteeEnergyIndependenceGlobalWarming extends EventScraper_Abstract 
{
...
$parser = new HouseCommitteeSelectCommitteeEnergyIndependenceGlobalWarming;
$parser->run();
