...
class SenateCommitteeNaturalResources extends EventScraper_Abstract 
{
    
    protected $url = 'http://www3.capwiz.com/c-span/dbq/officials/schedule.dbq?committee=hreso&command=committee_schedules&chambername=Senate&chamber=S&period=';
    public $parser_name = 'C-SPAN Senate Natural Resources Committee Schedule';
...
$parser = new SenateCommitteeNaturalResources;
$parser->run();
