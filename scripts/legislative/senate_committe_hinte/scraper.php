...
class SenateCommitteeForeignAffairs extends EventScraper_Abstract 
{
    
    protected $url = 'http://www3.capwiz.com/c-span/dbq/officials/schedule.dbq?committee=hinte&command=committee_schedules&chambername=Senate&chamber=S&period=';
    public $parser_name = 'C-SPAN Senate Foreign Affairs Committee Schedule';
...
$parser = new SenateCommitteeForeignAffairs;
$parser->run();
