...
class SenateCommitteeScienceTechnology extends EventScraper_Abstract 
{
    
    protected $url = 'http://www3.capwiz.com/c-span/dbq/officials/schedule.dbq?committee=hscie&command=committee_schedules&chambername=Senate&chamber=S&period=';
    public $parser_name = 'C-SPAN Senate Science and Technology Committee Schedule';
...
$parser = new SenateCommitteeScienceTechnology;
$parser->run();
